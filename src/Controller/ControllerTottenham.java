...
public abstract class ControllerTottenham {
    //
    ...
    public static void tilføjSpillereTottenham() {
        ...
        try {
            ...
            for (int i = 0; i < spillerNavn.length; i++) {
                Spiller spiller = ControllerKlubber.opretSpiller(spillerNavn[i], "England", ControllerKlubber.klubMap.get("TOT"), spillerPosition[i], (alder[i]), rygNummer[i]);
    ...
    public static void tilføjRygnummerTottenham() {
        final String url = "https://www.transfermarkt.com/tottenham-hotspur/startseite/verein/148";
        try {
            final Document document = Jsoup.connect(url).get();
            int rygnummerTal = 0;
    ...
    public static void tilføjAlderTottenham() {
        final String url = "https://www.transfermarkt.com/tottenham-hotspur/startseite/verein/148";
        try {
            final Document document = Jsoup.connect(url).get();
            int alderTal = 0;
    ...
    public static void tilføjTottenham() {
        tilføjRygnummerTottenham();
        tilføjAlderTottenham();
        tilføjSpillereTottenham();
    }
}
